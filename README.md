...
```sh
git clone https://github.com/nickjj/docker-django-example satguru_classes
cd satguru_classes
...
The app is named `satguru_classes` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "satguru_classes" and update a few Docker related resources.
